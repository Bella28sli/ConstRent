...
urlpatterns = [
    ...
    path('clients/individuals/', views.IndividualClientView.as_view(), name='clients_individual'),
    path('clients/companies/', views.CompanyClientView.as_view(), name='clients_company'),
